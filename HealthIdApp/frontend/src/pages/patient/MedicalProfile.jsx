      ...
      <div className="glass-panel">
        ...
        <form onSubmit={handleUpdate} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div className="input-group">
            ...
            <textarea name="allergies" className="glass-input" rows="3" placeholder="List any known allergies to medication, food, etc." value={formData.allergies} onChange={handleChange} />
          </div>

          <div className="input-group">
            <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <FaUserNurse color="var(--secondary-color)"/> Emergency Contact Number
            </label>
